    ...
    <>
      ...
      <Router>
        <Routes>
          ...
          <Route path='/operation/:id/:action' useParams={['id', 'action']}
            element={
              isAuthenticated ?
                (  <OperacoesView />)
                : <Navigate to="/login" />
          ...
          <Route path='/resources/:id/:action' useParams={['id', 'action']} element={isAuthenticated ? <ResourcesNew /> : <Navigate to="/login" />
          }></Route>
